...
<body>
	...
	<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<script type="text/javascript" charset="utf-8" src="${ctxStatic}/lang/zh-cn/zh-cn.js"></script>
			<script id="editor" name="articleData.content" type="text/plain" style="width:95%;height: 400px;">${article.articleData.content}</script>
			<script type="text/javascript">
			    //实例化编辑器
